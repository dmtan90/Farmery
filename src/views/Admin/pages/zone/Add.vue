		...
		el-row(:gutter="20")
			...
			el-col(:xs="24" :md="16")
				el-form-item.electric-form-input(:label="$t('common.name')")
					el-input(type="text" v-model="zone.name" placeholder="Up to 64 characters" maxlength="64" clearable size="small")
...
@Component({
	...
	methods: {
		...
		...mapActions('zone', ['create','getTypes','getUnits','getCultivations']),
		async loadData() {
			//load farms
